...
SELECT * FROM Projects WHERE complete ='1'`)).recordset;
    for (let project of projects) {
        ejs_1.default.renderFile('template/admin.ejs', { email: project.user_id, name: project.name }, (error, data) => __awaiter(void 0, void 0, void 0, function* () {
            let messageoption = {
            ...
            try {
                ...
                yield pool.request().query(`UPDATE Projects SET complete='2' WHERE ProjectsId = '${project.id}'`);
